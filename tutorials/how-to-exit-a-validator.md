...
- [Exiting a Teku validator ↗](https://docs.teku.consensys.net/en/latest/HowTo/Voluntary-Exit/)
- [Exiting an eth-docker validator ↗](https://eth-docker.net/docs/Support/Exit/)
